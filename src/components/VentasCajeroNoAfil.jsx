...
function VentasCajeroNoAfil() {
    const [startDate, setstartDate] = useState(new Date());
    const [endDate, setEndDate] = useState(new Date());
    const [ventasCajero, setventasCajero] = useState([]);
    const initialURL = 'https://localhost:44395/api/InformesVentas/VentasCajeroNoAfil?FechaInicial=' + dateFormat(startDate, "dd-mm-yyyy") + '&FechaFinal=' + dateFormat(endDate, "dd-mm-yyyy")
    ...
    const Fetching = async () => {
        ...
        setventasCajero(data.dataSetVentasCajeroNoAfil.Table)
    }
    ...
    const ExportExcel=()=>{
        ...
        XLSX.utils.book_append_sheet(wb,ws,"Ventas X Cajero No Afil");
        XLSX.writeFile(wb,"ventasCajero"+dateFormat(startDate, "dd-mm-yyyy")+-+dateFormat(endDate, "dd-mm-yyyy")+".xlsx");
        
    }
    
    // const CapturarFechas = (startDate, endDate, ventasCajero) => {
    //     alert("Fecha Inicial " + dateFormat(startDate, "dd-mm-yyyy") + " FechaFinal  " + dateFormat(endDate, "dd-mm-yyyy"))

    // }
    return (

        <div className='contenedor'>
            <h4>Ventas por cajero totales</h4>
            <div className='row'>
            ...
            <label id='lbl_conteo'></label>
        </div>

    );
}

export default VentasCajeroNoAfil;
